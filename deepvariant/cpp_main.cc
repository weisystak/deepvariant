      ...
      if (rangecount%task_number==task_id){
        ...
        for (auto dv_call:candidates){
          ...
          for (auto& alt:alt_allele_combinations){
            ...
            std::string refrow;
            refrow.append(refimgrow->base.begin(), refimgrow->base.end());
            refrow.append(refimgrow->base_quality.begin(), refimgrow->base_quality.end());
            refrow.append(refimgrow->mapping_quality.begin(), refimgrow->mapping_quality.end());
            refrow.append(refimgrow->on_positive_strand.begin(), refimgrow->on_positive_strand.end());
            refrow.append(refimgrow->supports_alt.begin(), refimgrow->supports_alt.end());
            refrow.append(refimgrow->matches_ref.begin(), refimgrow->matches_ref.end());
            ...
            for (auto& si:sortindex){
              imgptr->append(reads_rows[std::get<1>(si)].base.begin(), reads_rows[std::get<1>(si)].base.end());
              imgptr->append(reads_rows[std::get<1>(si)].base_quality.begin(), reads_rows[std::get<1>(si)].base_quality.end());
              imgptr->append(reads_rows[std::get<1>(si)].mapping_quality.begin(), reads_rows[std::get<1>(si)].mapping_quality.end());
              imgptr->append(reads_rows[std::get<1>(si)].on_positive_strand.begin(), reads_rows[std::get<1>(si)].on_positive_strand.end());
              imgptr->append(reads_rows[std::get<1>(si)].supports_alt.begin(), reads_rows[std::get<1>(si)].supports_alt.end());
              imgptr->append(reads_rows[std::get<1>(si)].matches_ref.begin(), reads_rows[std::get<1>(si)].matches_ref.end());
            }
